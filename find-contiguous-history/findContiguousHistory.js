function findContiguousHistory(urls1 = [], urls2 = []) {
  ...
  console.log(findMatches(histories1, urls2))
...
findContiguousHistory(user0, user1); // should be ['/pink', '/register', '/orange']
findContiguousHistory(user3, user4); // should be ["/green", "/blue", "/purple", "/white"]
findContiguousHistory(user0, user2); // should be ['a']
findContiguousHistory(user1, user2); // should be []